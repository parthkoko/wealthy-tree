          ...
          <div className="investmeant-services-innerdetail">
            <div className="ourservice-inner-card-data">
              ...
              <div className="serviceinner-card-details">
                ...
                <p>
                  Ensure your family’s financial safety even in your absence. We
                  help you choose the right term and endowment plans.
                </p>
            ...
            <div className="ourservice-inner-card-data">
              ...
              <div className="serviceinner-card-details">
                ...
                <p>
                  Stay protected from rising medical costs with customized
                  health coverage that fits your lifestyle.
                </p>
                {/* <button className='flex gap-1 items-center'><span>Read More</span> <span><img src={righttoparrow} alt="righttoparrow" /></span></button> */}
              </div>
            </div>
            <div className="ourservice-inner-card-data">
              ...
              <div className="serviceinner-card-details">
                ...
                <p>
                  Safeguard your assets - home, travel, vehicles, and more -
                  with the right general insurance plans.
                </p>
                {/* <button className='flex gap-1 items-center'><span>Read More</span> <span><img src={righttoparrow} alt="righttoparrow" /></span></button> */}
              </div>
            </div>
